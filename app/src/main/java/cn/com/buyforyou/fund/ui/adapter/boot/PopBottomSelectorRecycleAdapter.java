...
public class PopBottomSelectorRecycleAdapter extends SimpleRecAdapter<String, PopBottomSelectorRecycleAdapter.ViewHolder> {

    public static final int ITEM_CLICK = 0;    //点击标识

    public PopBottomSelectorRecycleAdapter(Context context) {
        super(context);
    }
