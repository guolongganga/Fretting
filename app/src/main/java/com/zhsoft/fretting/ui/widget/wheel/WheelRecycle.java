...
package com.zhsoft.fretting.ui.widget.wheel;
...
public class WheelRecycle {
	...
	/**
	 * Adds view to specified userCache. Creates a userCache list if it is null.
	 * @param view the view to be cached
	 * @param cache the userCache list
	 * @return the userCache list
	 */
	...
	/**
	 * Adds view to userCache. Determines view type (item view or empty one) by index.
	 * @param view the view to be cached
	...
	/**
	 * Gets view from specified userCache.
	 * @param cache the userCache
	 * @return the first view from userCache.
	 */
