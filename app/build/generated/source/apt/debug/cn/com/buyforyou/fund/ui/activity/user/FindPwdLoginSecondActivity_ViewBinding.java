...
public class FindPwdLoginSecondActivity_ViewBinding<T extends FindPwdLoginSecondActivity> implements Unbinder {
  protected T target;

  @UiThread
  public FindPwdLoginSecondActivity_ViewBinding(T target, View source) {
    this.target = target;
