...
public class TransactionSingleContentFragment_ViewBinding<T extends TransactionSingleContentFragment> implements Unbinder {
  protected T target;

  @UiThread
  public TransactionSingleContentFragment_ViewBinding(T target, View source) {
    this.target = target;
