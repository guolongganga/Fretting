...
public class TransactionQueryActivity_ViewBinding<T extends TransactionQueryActivity> implements Unbinder {
  protected T target;

  @UiThread
  public TransactionQueryActivity_ViewBinding(T target, View source) {
    this.target = target;
