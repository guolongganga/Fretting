...
public class TransactionContentRecycleAdapter$ViewHolder_ViewBinding<T extends TransactionContentRecycleAdapter.ViewHolder> implements Unbinder {
  protected T target;

  @UiThread
  public TransactionContentRecycleAdapter$ViewHolder_ViewBinding(T target, View source) {
    this.target = target;
