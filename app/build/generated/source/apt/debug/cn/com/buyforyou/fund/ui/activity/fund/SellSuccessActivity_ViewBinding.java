...
public class SellSuccessActivity_ViewBinding<T extends SellSuccessActivity> implements Unbinder {
  protected T target;

  @UiThread
  public SellSuccessActivity_ViewBinding(T target, View source) {
    this.target = target;
