...
public class FundContentRecycleAdapter$ViewHolder_ViewBinding<T extends FundContentRecycleAdapter.ViewHolder> implements Unbinder {
  protected T target;

  @UiThread
  public FundContentRecycleAdapter$ViewHolder_ViewBinding(T target, View source) {
    this.target = target;
