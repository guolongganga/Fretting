...
public class FundContentFragment_ViewBinding<T extends FundContentFragment> implements Unbinder {
  protected T target;

  @UiThread
  public FundContentFragment_ViewBinding(T target, View source) {
    this.target = target;
