...
public class FindPwdTradeFirstActivity_ViewBinding<T extends FindPwdTradeFirstActivity> implements Unbinder {
  protected T target;

  @UiThread
  public FindPwdTradeFirstActivity_ViewBinding(T target, View source) {
    this.target = target;
