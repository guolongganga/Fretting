...
public class PopBottomSelectorRecycleAdapter2$ViewHolder_ViewBinding<T extends PopBottomSelectorRecycleAdapter2.ViewHolder> implements Unbinder {
  protected T target;

  @UiThread
  public PopBottomSelectorRecycleAdapter2$ViewHolder_ViewBinding(T target, View source) {
    this.target = target;
