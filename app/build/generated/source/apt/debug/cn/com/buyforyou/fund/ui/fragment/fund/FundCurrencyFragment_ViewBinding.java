...
public class FundCurrencyFragment_ViewBinding<T extends FundCurrencyFragment> implements Unbinder {
  protected T target;

  @UiThread
  public FundCurrencyFragment_ViewBinding(T target, View source) {
    this.target = target;
