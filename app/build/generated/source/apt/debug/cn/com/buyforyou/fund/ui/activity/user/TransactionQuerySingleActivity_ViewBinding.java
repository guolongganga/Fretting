...
public class TransactionQuerySingleActivity_ViewBinding<T extends TransactionQuerySingleActivity> implements Unbinder {
  protected T target;

  @UiThread
  public TransactionQuerySingleActivity_ViewBinding(T target, View source) {
    this.target = target;
